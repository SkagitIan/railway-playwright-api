...
DISCOVERY_CLASSIFIER_MODEL = os.environ.get("DISCOVERY_CLASSIFIER_MODEL", "gpt-4.1-mini")
DISCOVERY_CLASSIFY_CONCURRENCY = int(os.environ.get("DISCOVERY_CLASSIFY_CONCURRENCY", "8"))
